define([
        'jquery',
        'text!group/mat/tmpl/List.html',
        'text!group/mat/tmpl/List_Mat_Cat.html' ,
        ],
        function($, 
        		Tmpl_List,
        		Tmpl_List_Typ_Std
	...
	var CtrlList 	= function (header, content, footer, grpName) {
		...
		this.do_lc_init		= function(){
			tmplName.LIST								= "List";
			tmplName.LIST_TYP_STD						= "List_Typ_Std";
			
			tmplCtrl.do_lc_put_tmpl(tmplName.LIST				, Tmpl_List);
			tmplCtrl.do_lc_put_tmpl(tmplName.LIST_TYP_STD		, Tmpl_List_Typ_Std);  
			//-----------------------------------------------------------------------------------
		...
		this.do_lc_show = function(){               
			try{
				...
				self.do_lc_show_byTypeStat("#div_List_Typ_Std"		, tmplName.LIST_TYP_STD	 		, 	null	, null	, null);
				//---------------------------------------------------------------
