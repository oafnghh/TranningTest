define([
        'jquery',
        'text!group/tpy/info_version/tmpl/Ent_Btn.html',
        'text!group/tpy/info_version/tmpl/Ent_Btn_Sub.html',
        ],
...
//				else
				...
				console.log(e);
				do_gl_exception_send(App.path.BASE_URL_API_PRIV,  "tpy.information", "EntBtn", "do_lc_show", e.toString()) ;
			}
		};
