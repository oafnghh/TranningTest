...
//	'text!template/shp/per/Per_List_New_Header.html',
//	'text!template/shp/per/Per_List_New_Content.html',
	 
    'text!template/shp/per/Per_List_Client_Header.html',
//    'text!template/shp/per/Per_List_Prospect_Header.html',
    'text!template/shp/per/Per_List_Producer_Header.html',  
    'text!template/shp/per/Per_List_Supplier_Header.html',
    'text!template/shp/per/Per_List_Thirdparty_Header.html',
    
//    'text!template/shp/per/Per_List_Doctor_Header.html',
   
     
    'text!template/shp/per/Per_List_Content.html'
     
//    'text!template/shp/per/Per_List_Filter_Header.html',  
// 	'text!template/shp/per/Per_List_Filter_Box.html',
...
//				}
		...
		function doLoadView(typePartner){
			var div = null;
//			if(typePartner == statPartnerNew){
//				div = "#div_Per_List_New";
//				$("#div_Per_List_New_Header")		.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PER_LIST_NEW_HEADER			, {}));
//				$("#div_Per_List_New_Content")		.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PER_LIST_NEW_CONTENT			, {}));
//				return div;
//			}
...
//				div = "#div_Per_List_Prospect";
//				$("#div_Per_List_Prospect_Header")	.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PER_LIST_PROSPECT_HEADER			, {}));
//			}
			if(typePartner == typePartnerProducer){
				div = "#div_Per_List_Producer";
				$("#div_Per_List_Producer_Header")	.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PER_LIST_PRODUCER_HEADER		, {}));
			}
			if(typePartner == typePartnerSupplier){
				div = "#div_Per_List_Supplier";
				$("#div_Per_List_Supplier_Header")	.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PER_LIST_PROVIDER_HEADER		, {}));
			}
			
//			if(typePartner == typePartnerDoctor){
//				div = "#div_Per_List_Doctor";
//				$("#div_Per_List_Doctor_Header")	.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PER_LIST_DOCTOR_HEADER				, {}));
//			}
			
			if(typePartner == typePartnerThirdparty){
				div = "#div_Per_List_Thirdparty";
				$("#div_Per_List_Thirdparty_Header")	.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PER_LIST_THIRDPARTY_HEADER		, {}));
			}
