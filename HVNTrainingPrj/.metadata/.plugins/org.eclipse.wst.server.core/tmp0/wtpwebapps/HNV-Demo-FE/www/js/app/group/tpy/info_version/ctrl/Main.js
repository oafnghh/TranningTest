define([
        ...
        'text!group/tpy/info_version/tmpl/Main.html',
        
        'group/tpy/info_version/ctrl/List',
        'group/tpy/info_version/ctrl/Ent',
	...
	var CtrlMain 	= function (header, content, footer, grpName) {
		...
		//------------------------------------------------------------------------------------
		var pr_grpPath				= 'group/tpy/info_version/';
...
//				do_gl_apply_right($(pr_divContent));
				...
				console.log(e);
				do_gl_exception_send(App.path.BASE_URL_API_PRIV,  "tpy.information", "Main", "do_lc_show", e.toString()) ;
			}
		};
	};
