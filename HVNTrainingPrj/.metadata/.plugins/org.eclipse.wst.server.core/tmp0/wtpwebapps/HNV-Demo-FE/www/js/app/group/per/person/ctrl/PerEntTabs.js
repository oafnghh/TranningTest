define([
	'jquery',
	'text!template/shp/per/Per_Ent_Tabs.html'
	],
	function($, 
			Per_Ent_Tabs        		
	) {
...
//		var typePartnerDoctor		= 1010005;
		...
		this.do_lc_init						= function(){
			...
			pr_ctr_TabFin					= App.controller.Per.EntTabFinance;
		...
		this.do_lc_show		= function(obj, mode){
			...
			try{
				...
				if (mode !=  App['const'].MODE_NEW) pr_ctr_TabOrders	 				.do_lc_show(pr_obj, pr_mode);

				pr_ctr_TabNote						.do_lc_show(pr_obj, pr_mode);
				pr_ctr_TabDoc						.do_lc_show(pr_obj, pr_mode);
				pr_ctr_TabFin						.do_lc_show(pr_obj, pr_mode);
