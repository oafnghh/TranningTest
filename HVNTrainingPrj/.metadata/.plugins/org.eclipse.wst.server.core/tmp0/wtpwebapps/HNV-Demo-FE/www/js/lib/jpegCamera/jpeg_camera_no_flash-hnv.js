...
//						this._load_shutter_sound(this.options.shutter_mp3_url);
				...
				success = function(stream) {
					...
					JpegCamera._media_stream = stream;
					JpegCamera._media_stream.stop = function () {
				...
				failure = function(error) {
					...
					that.message.innerHTML = 
							...
							"<span style=\"color: red;\">" + " You have denied camera access." 
						+ 	"</span><br><br>" + "Look for camera icon around your address bar to change your " + "decision.";
			...
			JpegCameraHtml5.prototype._engine_fileinput = function(snapshot, fileinputObj, csrf_token, timeout) {
	...
	Snapshot = (function() {
		...
		Snapshot.prototype.upload_fileinput = function(object) {
//			var cache;
//			if (options == null) {
//			options = {};
//			}
...
//			return this.camera._engine_upload(this, cache.api_url, csrf_token, cache.timeout);
			return this.camera._engine_fileinput(this, cache, csrf_token, cache.timeout);
		};
