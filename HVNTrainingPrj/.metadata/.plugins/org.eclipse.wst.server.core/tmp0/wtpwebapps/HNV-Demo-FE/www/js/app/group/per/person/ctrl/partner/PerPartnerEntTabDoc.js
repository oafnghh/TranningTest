define([
        'jquery',
        'text!template/per/partner/PerPartner_Ent_Tab_Doc.html',
	...
	var PerPartnerEntTabDoc     = function (header,content,footer, grpName) {
		...
		this.do_lc_show		= function(obj, mode){
			...
			try{
				...
				$("#div_PerPartner_Ent_Tab_Doc").html(tmplCtrl.req_lc_compile_tmpl(tmplName.PER_PARTNER_ENT_TAB_DOC, obj));
				do_bind_event();
			}catch(e) {
				do_gl_show_Notify_Msg_Error("PerPartnerEntTabDoc " + e.toString());
				do_gl_exception_send(App.path.BASE_URL_API_PRIV,  "per.partner", "PerPartnerEntTabDoc", "do_lc_show", e.toString()) ;
			}
		};
