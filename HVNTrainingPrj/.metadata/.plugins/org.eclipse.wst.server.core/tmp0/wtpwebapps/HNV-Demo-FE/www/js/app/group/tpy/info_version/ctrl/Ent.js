define([
	'jquery',
	'text!group/tpy/info_version/tmpl/Ent.html',
	
	'group/tpy/info_version/ctrl/EntHeader',
    'group/tpy/info_version/ctrl/EntBtn' 
...
//			fSucces.push(req_gl_funct(null	, do_refresh_list				, []));
		...
		var do_Disable_Edit = function(){
		    $("#descr").find("input, select, textarea").prop("disabled", true);
		    //$("#div_TpyCat_Ent").find(".setDisabled").prop("disabled", true);
		}
	}
	return CtrlEnt;
