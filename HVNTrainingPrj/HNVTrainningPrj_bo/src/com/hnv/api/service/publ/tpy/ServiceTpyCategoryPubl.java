...
public class ServiceTpyCategoryPubl implements IService {
	...
	// ---------------------------------------------------------------------------------------------------------
	private static CacheData<TaTpyCategory> cache_ent = new CacheData<TaTpyCategory>(100, DefTime.TIME_01_00_00_000, DefTime.TIME_00_30_00_000);
	...
	private static TaTpyCategory reqGet(Integer id, Boolean forced, Boolean wAvatar, Boolean wParent, Boolean wChild, Boolean wInfo)	throws Exception {
