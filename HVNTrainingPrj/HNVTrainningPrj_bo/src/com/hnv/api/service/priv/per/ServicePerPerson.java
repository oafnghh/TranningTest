...
public class ServicePerPerson implements IService {
	...
	private static TaPerPerson reqNew(TaAutUser user,  JSONObject json, HttpServletResponse response) throws Exception {
		...
		Integer idPerPerson 			= ent.reqId();
		Integer userId					= user.reqId();
		TaAutUser entUser 				= TaAutUser.DAO.reqEntityByRef(userId);
		JSONObject userObj 				= new JSONObject();
		userObj.put("perId", idPerPerson);
		Map<String, Object> attrUser 	= API.reqMapParamsByClass(userObj, TaAutUser.class);			
