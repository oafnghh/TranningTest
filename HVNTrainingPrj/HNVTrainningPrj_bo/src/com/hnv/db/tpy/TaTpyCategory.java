...
public class TaTpyCategory extends EntityAbstract<TaTpyCategory> {
	...
	public void doBuildInfo () throws Exception {
		this.O_Infos = TaTpyInformation.reqTpyInfomations(DefDBExt.ID_TA_TPY_CATEGORY, this.I_ID, null);
	}
	//-------------------------------------------------------------------------------------------------------
	...
	public static void doBuildDocuments (List<TaTpyCategory> list)  throws Exception{
		TaTpyDocument.doBuildTpyDocuments(list, DefDBExt.ID_TA_TPY_CATEGORY, null, null, TaTpyCategory.ATT_O_DOCUMENTS, false);
	}
